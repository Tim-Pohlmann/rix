...
/// clone (with a write credential), check whether a branch already exists, push a branch, and open a
/// pull request. Segregated from <see cref="IRepositoryHost"/> so the read-only job path never
/// depends on write capabilities.</summary>
