...
public class LocalApiServerTests
{
    ...
    private static StubJobHost FakeHost(bool branchExists) => new(_ => Task.FromResult(branchExists));
    ...
    {
        var host = new StubJobHost(branchExistsLocally: _ => Task.FromResult(false));
