...
public class TypesTests
{
    ...
    public void JobSuccess_SerializesCorrectly()
    {
        ...
        var outcome = new JobSuccess(prs, PendingPushRequests: [], PendingUpdateRequests: [], PendingRevertRequests: [], CostUsd: 0.0125m, Duration: TimeSpan.FromSeconds(42));
        ...
        Assert.AreEqual(0, root.GetProperty("pendingUpdateRequests").GetArrayLength());
        Assert.AreEqual(0, root.GetProperty("pendingRevertRequests").GetArrayLength());
    }
